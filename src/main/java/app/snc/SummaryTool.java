...
class SummaryTool{
    ...
    SummaryTool(){
        try {
            in = new FileInputStream("C:/SnC/Summarizer/tmp_in.txt");
    ...
    SummaryTool(String in_file){

        try {
            this.in = new FileInputStream(in_file);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        out = null;
    ...
    public void SaveSummary(String path){
        ...
        String s[] = result.split("\\s+");  //seperate words
        sb = new StringBuilder();
        for(String str:s){
            str = str.replaceAll("\\W",""); //remove all non word characters
            sb.append(str+" ");
        }
        //result = result.replaceAll("\\W","");
        result = sb.toString();
        try{
            PrintWriter pw_out = new PrintWriter(f);
            pw_out.write(result.toLowerCase());
            pw_out.close();
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public String printSummary(){
        ...
        File out_file = new File("C:/SnC/Summarizer/tmp_out.txt");
        StringBuilder sb = new StringBuilder();
        for(Sentence sentence : contentSummary){
            System.out.println(sentence.value);
            sb.append(sentence.value);
        ...
        result = sb.toString();
        try{
            PrintWriter pw_out = new PrintWriter(out_file);
            pw_out.write(result.toLowerCase());
            pw_out.close();
        }catch (Exception e){
            e.printStackTrace();
